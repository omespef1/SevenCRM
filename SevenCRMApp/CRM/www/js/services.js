...
angular.module('sevencrm.services', [])
    ...
    .service('flujosservice', function ($resource, SessionValues, $q, $http) {
        ...
        this.cantidadFlujos = function (emp_codi, usu_codi) {
            var df = $q.defer();
            $http.get(SessionValues.getConexion() +
                '/api/Flujos/cantidadFlujos?emp_codi=' + emp_codi+ '&usu_codi=' + usu_codi)
                .success(
                    function (response) {
                        df.resolve(response);
                    }).error(function (error, status) {
    ...
    .service('actividadSrv', function (SessionValues, $q, $http) {
        ...
        this.crearActividad = function (data) {
            var df = $q.defer();
            $http.post(SessionValues.getConexion() +
                '/api/Actividades/guardarActividad', data)
                .success(
                    function (response) {
                        df.resolve(response);
                    }).error(function (error, status) {
        ...
        this.invitarActividad = function (data) {
            var df = $q.defer();
            $http.post(SessionValues.getConexion() +
                '/api/Actividades/invitarActividad', data)
                .success(
                    function (response) {
                        df.resolve(response);
                    }).error(function (error, status) {
